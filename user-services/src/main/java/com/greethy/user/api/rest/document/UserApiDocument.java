...
@RouterOperations({
    @RouterOperation(
            ...
            operation =
                    @Operation(
                            ...
                            description =
                                    "Register a new Greethy UserAggregate using basic authenticating Username/Password with an Email to verify",
    ...
    @RouterOperation(
            ...
            operation =
                    @Operation(
                            parameters = @Parameter(name = "user-id", required = true),
    ...
    @RouterOperation(
            ...
            operation =
                    @Operation(
                            parameters =
                                    @Parameter(in = ParameterIn.PATH, name = "user_id", description = "The user's ID"),
                            ...
                            responses = {
                                ...
                                @ApiResponse(
                                        responseCode = "404",
                                        description =
                                                "The user's id from Path variable cannot found in Greethy Server's databases.",
                                        content =
                                                @Content(
                                                        mediaType = MediaType.APPLICATION_JSON_VALUE,
                                                        schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @RouterOperation(
            ...
            operation =
                    @Operation(
                            ...
                            tags = "Users",
                            responses = {
                                @ApiResponse(responseCode = "204", description = "Return nothing"),
                                @ApiResponse(
                                        responseCode = "401",
                                        description =
                                                "Bad or expired token. This can happen if the user revoked a token or the access token has expired. You should re-authenticate the user.",
