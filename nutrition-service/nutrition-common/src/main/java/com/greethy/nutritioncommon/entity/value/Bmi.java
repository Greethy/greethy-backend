...
/**
 * The {@code Bmi} class represents the Body Measure Index (BMI), which is calculated as a person's weight in kilograms divided by the square of their height in meters.
